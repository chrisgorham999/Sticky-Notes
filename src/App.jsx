            ...
            return (
                ...
                <div className={`min-h-screen p-8 ${darkMode ? 'bg-gradient-to-br from-gray-900 to-gray-800' : 'bg-gradient-to-br from-gray-100 to-gray-200'}`}>
                    <div className="flex gap-6 max-w-full mx-auto items-start">
                        ...
                        {(mainTab === 'notes') ? (
                            /* Watch List Panel */
                            <div className={`flex-shrink-0 ${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-lg shadow-lg flex flex-col`} style={{width: '23%', maxHeight: 'calc(100vh - 15rem)', marginTop: '190px'}}>
